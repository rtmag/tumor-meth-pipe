...
boxplot(gene ~ cell, vertical = TRUE, data = FOXM1,ylab = expression('Log2 FOXM1 TPM'),names=c("TP53 Mutant","Normal","TP53 WT"),outline=F)
stripchart(gene ~ cell, vertical = TRUE, data = FOXM1, jitter = 0.3, ylab = expression('Log2 FOXM1 TPM'),
